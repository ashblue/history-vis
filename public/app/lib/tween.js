...
define(
    ...
    function (
         ...
         * @returns {self}
         */
        var Tween = function (startValue, distance, duration, animationType, loop) {
        ...
        Tween.prototype.getValue = function () {
            // Run normally
            if (!this.expired()) {
                var total = _easingLibrary[this.animationType](delta.now - this.startTime, this.startValue, this.distance, this.duration);
         ...
         */
        Tween.prototype.getStartTime = function () {
            return delta.now - this.startTime - this.duration + delta.now;
        };
         ...
         */
        Tween.prototype.expired = function () {
            return this.startTime + this.duration < delta.now;
        };
         ...
         * @returns {self}
         */
        Tween.prototype.set = function (startValue, distance, duration, animationType, loop) {
